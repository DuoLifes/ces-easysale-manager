  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import('../views/system/tag/ConfigTagSite.vue'),
      },
      {
        path: 'strategy',
        name: 'strategy',
      ...
      {
        path: 'configStrategySite/:id',
        name: 'configStrategySite',
        meta: {
          title: '局点配置',
          permiss: '1_8_3',
          parentPath: '/strategy',
        },
        component: () => import('../views/system/strategy/ConfigStrategySite.vue'),
      },
      {
        path: 'prospect',
        name: 'prospect',
